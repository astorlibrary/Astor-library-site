...
export const presentations = {
  ...
  'biography-f-scott-fitzgerald': { title: 'Biography of F. Scott Fitzgerald', folder: '/assets/presentations/biography-f-scott-fitzgerald/', backdrop: '/assets/presentation-backdrops/fitzgerald-gatsby.png', slideCount: 16 },
  'great-gatsby-notes-critical-reading': { title: 'The Great Gatsby: Notes & Critical Reading', folder: '/assets/presentations/great-gatsby-notes-critical-reading/', backdrop: '/assets/presentation-backdrops/fitzgerald-gatsby.png', slideCount: 16 },
  'great-gatsby-character-study': { title: 'The Great Gatsby: Character Study Guide', folder: '/assets/presentations/great-gatsby-character-study/', backdrop: '/assets/presentation-backdrops/fitzgerald-gatsby.png', slideCount: 14 },
  'turning-point-great-gatsby': { title: 'Turning Point in The Great Gatsby', folder: '/assets/presentations/turning-point-great-gatsby/', backdrop: '/assets/presentation-backdrops/fitzgerald-gatsby.png', slideCount: 9 },
  'biography-harper-lee': { title: 'Biography of Harper Lee', folder: '/assets/presentations/biography-harper-lee/', backdrop: '/assets/presentation-backdrops/harper-lee-mockingbird.png', slideCount: 10 },
  'gatsby-corruption-symbolism-illusion': { title: 'Corruption, Symbolism & Illusion in The Great Gatsby', folder: '/assets/presentations/gatsby-corruption-symbolism-illusion/', backdrop: '/assets/presentation-backdrops/fitzgerald-gatsby.png', slideCount: 8 },
  'to-kill-a-mockingbird-characters': { title: 'To Kill a Mockingbird: Character List & Major Themes', folder: '/assets/presentations/to-kill-a-mockingbird-characters/', backdrop: '/assets/presentation-backdrops/harper-lee-mockingbird.png', slideCount: 21 },
  'gatsby-death-relationships': { title: 'Death of a Character & Important Relationships in The Great Gatsby', folder: '/assets/presentations/gatsby-death-relationships/', backdrop: '/assets/presentation-backdrops/fitzgerald-gatsby.png', slideCount: 9 },
  'gatsby-essay-plan': { title: 'Great Gatsby Essay Plan', folder: '/assets/presentations/gatsby-essay-plan/', backdrop: '/assets/presentation-backdrops/fitzgerald-gatsby.png', slideCount: 8 },
  'admiration-for-gatsby': { title: 'Admiration for Gatsby in The Great Gatsby', folder: '/assets/presentations/admiration-for-gatsby/', backdrop: '/assets/presentation-backdrops/fitzgerald-gatsby.png', slideCount: 9 },
  'things-we-admire-gatsby': { title: 'Things We Admire About Gatsby', folder: '/assets/presentations/things-we-admire-gatsby/', backdrop: '/assets/presentation-backdrops/fitzgerald-gatsby.png', slideCount: 11 },
  'great-gatsby-corruption-illusion-v2': { title: 'The Great Gatsby: Corruption, Illusion & the American Dream', folder: '/assets/presentations/great-gatsby-corruption-illusion-v2/', backdrop: '/assets/presentation-backdrops/fitzgerald-gatsby.png', slideCount: 9 },
  'wide-sargasso-sea-study-guide': { title: 'Wide Sargasso Sea: A Study Guide', folder: '/assets/presentations/wide-sargasso-sea-study-guide/', backdrop: '/assets/presentation-backdrops/wide-sargasso-sea.png', slideCount: 21 },
  'wide-sargasso-sea-part-3': { title: 'Wide Sargasso Sea — Part 3 Summary & Analysis', folder: '/assets/presentations/wide-sargasso-sea-part-3/', backdrop: '/assets/presentation-backdrops/wide-sargasso-sea.png', slideCount: 14 },
  'king-lear-summary-analysis': { title: 'King Lear: Summary Guide', folder: '/assets/presentations/king-lear-summary-analysis/', backdrop: '/assets/presentation-backdrops/king-lear.png', slideCount: 18 },
  'gender-power-omkara-maqbool': { title: 'Gender, Power & Shakespeare: Omkara and Maqbool', folder: '/assets/presentations/gender-power-omkara-maqbool/', backdrop: '/assets/presentation-backdrops/omkara-maqbool.png', slideCount: 12 },
  'pride-prejudice-key-quotes': { title: 'Pride and Prejudice: Key Quotes Revision', folder: '/assets/presentations/pride-prejudice-key-quotes/', backdrop: '/assets/presentation-backdrops/pride-prejudice.png', slideCount: 10 },
  'dracula-gender-roles': { title: 'Dracula: Gender Roles', folder: '/assets/presentations/dracula-gender-roles/', backdrop: '/assets/presentation-backdrops/dracula-gender.png', slideCount: 16 }
};
