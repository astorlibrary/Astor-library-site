...
function subjectPage(subject) {
  ...
  return '<!doctype html><html lang="en-GB"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1">' +
    ...
    '<section class="subject-guide-hero"><div><p class="kicker">' + escapeHtml(subject.kicker) + '</p><h1>' + escapeHtml(subject.title) + '</h1><p class="deck">' + escapeHtml(subject.description) + '</p><div class="button-row"><a class="button primary" href="#subject-books">See the books</a><a class="button secondary" href="/subjects/">All subjects</a></div></div>' +
    ...
    '<section class="subject-opening"><p class="kicker">The form</p><div><h2>' + escapeHtml(subject.introduction.heading) + '</h2>' + subject.introduction.paragraphs.map(function (paragraph) { return '<p>' + escapeHtml(paragraph) + '</p>'; }).join('') + '</div></section>' +
    ...
    '<section class="subject-shelf" id="subject-books" aria-labelledby="subject-books-title"><div class="subject-shelf-head"><div><p class="kicker">In Astor Library</p><h2 id="subject-books-title">Books in this guide</h2></div><p>These books are joined by a form or method, not flattened into one argument. Open any reading page for its own publication history, structure, language and afterlife.</p></div><div class="subject-book-grid">' + books + '</div></section>' +
...
function subjectIndex() {
  ...
  return '<!doctype html><html lang="en-GB"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1">' +
    '<title>Literature Subjects and Genre Guides | Astor Library</title><meta name="description" content="Follow one idea across the catalogue: comedy, tragedy, the Gothic, detective fiction, epic, satire, narration, and slavery and abolition."><link rel="stylesheet" href="/assets/styles.css"></head><body>' +
