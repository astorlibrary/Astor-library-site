...
function subjectPage(subject) {
  ...
  return '<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1">' +
    ...
    '<section class="subject-sources"><div><p class="kicker">Sources</p><h2>Texts, archives and research collections.</h2></div><p>These external collections provide the texts, manuscripts, historical records and specialist research used in this guide.</p><nav class="source-list" aria-label="' + escapeHtml(subject.title) + ' sources">' + sources + '</nav></section>' +
