...
function subjectIndex() {
  ...
  return '<!doctype html><html lang="en-GB"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1">' +
    '<title>Literature Subjects and Genre Guides | Astor Library</title><meta name="description" content="Follow one idea across the shelf: comedy, tragedy, the Gothic, detective fiction, epic, satire, narration, and slavery and abolition."><link rel="stylesheet" href="/assets/styles.css"></head><body>' +
