...
function subjectPage(subject) {
  ...
  return '<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1">' +
    ...
    '<section class="subject-opening"><p class="kicker">Definition and history</p><div><h2>' + escapeHtml(subject.introduction.heading) + '</h2>' + subject.introduction.paragraphs.map(function (paragraph) { return '<p>' + escapeHtml(paragraph) + '</p>'; }).join('') + '</div></section>' +
    '<section class="subject-method" aria-labelledby="subject-method-title"><div class="section-title"><p class="kicker">Reading method</p><h2 id="subject-method-title">Features to examine.</h2></div><div class="subject-method-grid">' + methods + '</div></section>' +
    '<section class="subject-shelf" id="subject-books" aria-labelledby="subject-books-title"><div class="subject-shelf-head"><div><p class="kicker">Astor editions</p><h2 id="subject-books-title">Books in this subject guide.</h2></div><p>Each book page includes a summary, publication information and analysis specific to that work.</p></div><div class="subject-book-grid">' + books + '</div></section>' +
    ...
    '<section class="subject-terms" aria-labelledby="subject-terms-title"><div class="section-title"><p class="kicker">Terminology</p><h2 id="subject-terms-title">Four terms used in this guide.</h2></div><div>' + terms + '</div></section>' +
    '<section class="subject-resources"><div><p class="kicker">Related resources</p><h2>Free guides and reading lists.</h2></div><div class="subject-resource-links">' + resources + '</div></section>' +
    '<section class="subject-sources"><div><p class="kicker">Sources</p><h2>Texts, archives and research collections.</h2></div><p>Where the texts, manuscripts, records and research behind this guide come from.</p><nav class="source-list" aria-label="' + escapeHtml(subject.title) + ' sources">' + sources + '</nav></section>' +
    ...
    '</main><footer class="site-footer"><div><p class="footer-brand">Astor Library</p><p>Subject guides, complete texts and free literature resources.</p></div><div class="footer-links"><a href="/subjects/">Subjects</a><a href="/authors/">Writers</a><a href="/library/">All books</a><a href="/resources/">Free resources</a></div></footer></body></html>';
}
...
function subjectIndex() {
  ...
  return '<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1">' +
    ...
    '<section class="subject-directory" id="subject-guides" aria-labelledby="subject-guides-title"><div class="section-title"><p class="kicker">' + subjects.length + ' guides</p><h2 id="subject-guides-title">All subject guides.</h2></div>' + cards + '</section>' +
    '<section class="subjects-reference"><div><p class="kicker">Two indexes</p><h2>Subject guides and reading lists.</h2></div><div><p><strong>Subject guides explain a form or method.</strong> Each one includes a short history, terminology and links to relevant books.</p><p><strong>Reading lists group books around a question.</strong> The lists cover home, freedom, fear, power, evidence, voice and knowledge across different periods and genres.</p><div class="button-row"><a class="button primary" href="/reading-routes/">Open the reading lists</a><a class="button secondary" href="/explore/">Search the catalogue</a></div></div></section>' +
    '</main><footer class="site-footer"><div><p class="footer-brand">Astor Library</p><p>Subject guides, author pages, complete texts and study resources.</p></div><div class="footer-links"><a href="/authors/">Writers</a><a href="/library/">All books</a><a href="/reading-routes/">Reading routes</a><a href="/resources/">Free resources</a></div></footer></body></html>';
}
