...
const MOTIFS = {
  ...
  ship: '<path d="M3.2 16.8h17.6c-1 2.4-2.9 3.6-5.7 3.6H8.9c-2.8 0-4.7-1.2-5.7-3.6Z"/><path d="M12 2.8v14"/><path d="M12.8 5.2c2.6.8 4.2 2.1 4.9 4h-4.9Zm0 6c2.8.7 4.5 2 5.2 3.9h-5.2Z"/><path d="M11.2 5.2c-2.6.8-4.2 2.1-4.9 4h4.9Zm0 6c-2.8.7-4.5 2-5.2 3.9h5.2Z"/>',
  ...
  holly: '<path d="M12 4.8c2.3 1.5 3.5 3.6 3.5 6.3s-1.2 4.8-3.5 6.3c-2.3-1.5-3.5-3.6-3.5-6.3S9.7 6.3 12 4.8Z"/><path d="M8.6 8.9 6.2 7.6M8.6 13.1l-2.4 1.3M15.4 8.9l2.4-1.3M15.4 13.1l2.4 1.3"/><circle cx="12" cy="19.6" r="1.1"/><circle cx="9.3" cy="18.6" r="1.1"/><circle cx="14.7" cy="18.6" r="1.1"/>',
  ...
  pumpkin: '<path d="M12 7.6c-1.6-.9-3.6-1-5.3-.2C4.2 8.6 2.8 11 2.8 13.7s1.4 5 3.9 6.1c1.7.8 3.7.7 5.3-.2 1.6.9 3.6 1 5.3.2 2.5-1.1 3.9-3.4 3.9-6.1s-1.4-5.1-3.9-6.3c-1.7-.8-3.7-.7-5.3.2Z"/><path d="M12 7.6c-1.5 1.6-2.2 3.6-2.2 6.1s.7 4.4 2.2 5.9c1.5-1.5 2.2-3.4 2.2-5.9s-.7-4.5-2.2-6.1Z"/><path d="M12 7.6c0-1.6.4-2.8 1.4-3.8"/><path d="M13.2 4.6c1.2-.6 2.6-.5 3.6.3-1.2.7-2.5.8-3.6-.3Z"/>',
