...
function bookPage(book) {
  ...
  const studyButton = book.studyUrl
    ? '<a class="button secondary" href="' + escapeHtml(book.studyUrl) + '">Buy the study edition</a>'
