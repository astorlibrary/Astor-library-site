...
collection = collection
  ...
  .replace(/<meta name="description" content="[^"]+">/, '<meta name="description" content="Astor Library publishes 39 editions across 37 Shakespeare plays, with complete texts, scene summaries, notes, sources, performance history and study guides.">')
  .replace('<h1>Shakespeare.</h1><p class="deck">Shakespeare&rsquo;s plays have never stood still. Read them through early print, the stories they borrowed and centuries of performance, from playhouse to screen.</p>', '<h1>Complete Shakespeare editions.</h1><p class="deck">Astor Library publishes all thirty-seven plays and two narrative poems. The editions contain complete texts, scene summaries, line numbers, explanatory notes, sources, performance context and study material.</p>')
