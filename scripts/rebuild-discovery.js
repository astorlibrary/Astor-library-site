...
const studyBookLinks = {
  ...
  'https://astorlibrary.com/go/a-midsummer-nights-dream-study': ['/books/a-midsummer-nights-dream/'],
  'https://astorlibrary.com/go/dorian-gray-study': ['/books/dorian-gray/'],
  'https://astorlibrary.com/go/dracula-study': ['/books/dracula/'],
  '/study/frankenstein/': ['/books/frankenstein/'],
  'https://astorlibrary.com/go/great-expectations-study': ['/books/great-expectations/'],
  '/study/hamlet/': ['/books/hamlet/'],
  '/study/jekyll-and-hyde/': ['/books/jekyll-and-hyde/'],
  'https://astorlibrary.com/go/king-lear-study': ['/books/king-lear/'],
  'https://astorlibrary.com/go/macbeth-study': ['/books/macbeth/'],
  'https://astorlibrary.com/go/merry-wives-of-windsor-study': ['/books/merry-wives-of-windsor/'],
  'https://astorlibrary.com/go/moby-dick-study': ['/books/moby-dick/'],
  'https://astorlibrary.com/go/much-ado-about-nothing-study': ['/books/much-ado-about-nothing/'],
  '/study/othello/': ['/books/othello/'],
  'https://astorlibrary.com/go/richard-iii-study': ['/books/richard-iii/'],
  '/study/romeo-and-juliet/': ['/books/romeo-and-juliet/'],
  'https://astorlibrary.com/go/tess-of-the-durbervilles-study': ['/books/tess-of-the-durbervilles/'],
  'https://astorlibrary.com/go/the-tempest-study': ['/books/the-tempest/'],
  'https://astorlibrary.com/go/macbeth-and-jekyll-and-hyde-study': ['/books/macbeth/', '/books/jekyll-and-hyde/'],
  'https://astorlibrary.com/go/macbeth-and-a-christmas-carol-study': ['/books/macbeth/', '/books/a-christmas-carol/'],
  'https://astorlibrary.com/go/romeo-and-juliet-and-jekyll-and-hyde-study': ['/books/romeo-and-juliet/', '/books/jekyll-and-hyde/'],
  'https://astorlibrary.com/go/romeo-and-juliet-and-a-christmas-carol-study': ['/books/romeo-and-juliet/', '/books/a-christmas-carol/'],
  'https://astorlibrary.com/go/alls-well-that-ends-well-study': ['/books/alls-well-that-ends-well/'],
  'https://astorlibrary.com/go/antony-and-cleopatra-study': ['/books/antony-and-cleopatra/'],
  'https://astorlibrary.com/go/as-you-like-it-study': ['/books/as-you-like-it/'],
  'https://astorlibrary.com/go/comedy-of-errors-study': ['/books/comedy-of-errors/'],
  'https://astorlibrary.com/go/coriolanus-study': ['/books/coriolanus/'],
  'https://astorlibrary.com/go/cymbeline-study': ['/books/cymbeline/'],
  'https://astorlibrary.com/go/henry-iv-parts-1-and-2-study': ['/books/henry-iv-parts-1-and-2/', '/books/henry-iv-part-1/', '/books/henry-iv-part-2/'],
  'https://astorlibrary.com/go/henry-iv-part-2-study': ['/books/henry-iv-part-2/'],
  'https://astorlibrary.com/go/henry-v-study': ['/books/henry-v/'],
  'https://astorlibrary.com/go/loves-labours-lost-study': ['/books/loves-labours-lost/'],
  'https://astorlibrary.com/go/measure-for-measure-study': ['/books/measure-for-measure/'],
  'https://astorlibrary.com/go/the-merchant-of-venice-study': ['/books/the-merchant-of-venice/'],
  'https://astorlibrary.com/go/mrs-dalloway-study': ['/books/mrs-dalloway/'],
  'https://astorlibrary.com/go/richard-ii-study': ['/books/richard-ii/'],
  'https://astorlibrary.com/go/the-taming-of-the-shrew-study': ['/books/taming-of-the-shrew/'],
  'https://astorlibrary.com/go/titus-andronicus-study': ['/books/titus-andronicus/'],
  'https://astorlibrary.com/go/twelfth-night-study': ['/books/twelfth-night/']
};
