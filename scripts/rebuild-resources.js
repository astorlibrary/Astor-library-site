...
${sections}
<section class="resource-editorial"><div><p class="kicker">Using the free library</p><h2>What the guides provide.</h2></div><div class="resource-editorial-copy"><p>Plot guides explain sequence, cause and consequence. Passage guides analyse language and form. Context guides explain relevant historical and literary information. The guides are designed for use alongside the complete work.</p><p>Teachers may use the guides for planning and discussion. Students may use them for revision, argument checking and close reading. <a href="/site-index/#free-guides">See every guide in the site index.</a></p></div></section>
